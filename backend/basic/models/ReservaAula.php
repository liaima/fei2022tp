...
class ReservaAula extends \yii\db\ActiveRecord
{
     ...
     * Gets query for [[Aula]].
     *
     * @return \yii\db\ActiveQuery|\app\models\query\AulaQuery
     */
    ...
    /**
     * {@inheritdoc}
     * @return \app\models\query\ReservaAulaQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\models\query\ReservaAulaQuery(get_called_class());
    }
}
