...
class HorarioMateria extends \yii\db\ActiveRecord
{
     ...
     *
     * @return \yii\db\ActiveQuery|\app\models\query\ReservaAulaQuery
     */
    ...
    /**
     * {@inheritdoc}
     * @return \app\models\query\HorarioMateriaQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\models\query\HorarioMateriaQuery(get_called_class());
    }
}
